...
@Component({
  selector: 'app-backendorder-rejected',
  templateUrl: './backendorder-rejected.component.html',
  styleUrls: ['./backendorder-rejected.component.css']
})
export class BackendorderRejectedComponent implements OnInit {
